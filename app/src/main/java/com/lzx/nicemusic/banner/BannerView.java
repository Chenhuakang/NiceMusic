package com.lzx.nicemusic.banner;
...
public class BannerView<T> extends RelativeLayout
    ...
    private LayoutParams viewpagerParmas;
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBannerLayout = findViewById(R.id.banner_layout);
        ...
        viewpagerParmas = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
     ...
     * 设置viewPager外边距
     */
    public BannerView setViewPagerMargin(float topMargin, float rightMargin,float bottomMargin, float leftMargin) {
        viewpagerParmas.leftMargin = dip2px(getContext(), leftMargin);
        viewpagerParmas.rightMargin = dip2px(getContext(), rightMargin);
        viewpagerParmas.topMargin = dip2px(getContext(), topMargin);
        viewpagerParmas.bottomMargin = dip2px(getContext(), bottomMargin);
        viewPager.setLayoutParams(viewpagerParmas);

        return this;
    }

    public BannerView setViewPagerClipChildren(boolean clipChildren){
        viewPager.setClipChildren(clipChildren);
        mBannerLayout.setClipChildren(clipChildren);
        return this;
    }

    public BannerView setCurrentItem(int item){
     ...
     * 隐藏Points
     */
    public BannerView hidePointsLayout() {
